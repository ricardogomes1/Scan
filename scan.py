...
def help():
	...
	print """
		...
		= EXEMPLO: python scan.py -t <ip destino>                =
		=                                                          =
		= [-g] Utilizar o programa no modo interface gráfica       =
		= EXEMPLO: python scan.py -g                             =
		=                                                          =
		= [--help ] ajuda do  programa                             =
		= EXEMPLO python scans.py --help                          =
		=                                                          =
		= [--verion] exibe a versão do programa                     =   
		= EXEMPLO: python scan.py --version                      =
		============================================================
...
if len(sys.argv) < 2:
	...
	class Programa:
		def __init__(self, toplevel):
			...
			Label(self.frame1,text='mrxrobot', fg='darkblue',font=('Verdana','10','bold'), height=3).pack() # cria uma Label
